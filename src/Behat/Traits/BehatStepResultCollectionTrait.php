...
trait BehatStepResultCollectionTrait
{
     ...
     */
    public function collectBehatStepResult(AfterStepTested $event): void
    {
     ...
     */
    public function getBehatStepResults(): array
    {
     ...
     */
    public function startBehatStepResultCollection(): void
    {
        $dispatcher = $this->getBehatContainer()->get(EventDispatcherExtension::DISPATCHER_ID);
        $dispatcher->addListener(StepTested::AFTER, [$this, 'collectBehatStepResult'], -999);
